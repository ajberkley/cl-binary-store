...
Currently this is sbcl specific, but I am working on making it work on other implementations.  Currently it loads on lispworks (the only one I've tried) but the tests don't pass, and it lacks any simple-array/simple-vector fast serializers / deserializers.
